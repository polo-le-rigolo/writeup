...
![SSH login](/images/1_ssh_login_start_machine.png)
...
![Ip configuration start machine](/images/2_ip_addr_start_machine.png)
...
![Hidden files on CCTV machine](/images/5_hidden_files_on_home_directory.png)
...
![CCTV screenshot 1](/images/6_snapshot_camera.jpg)
...
![CCTV screenshot 2](/images/7_snapshot_camera_credentials.jpg)
...
![Root on the bastion](/images/8_root_on_bastion.png)

Now let's go check our mails in `/home/admin/Mail/`

![Mail on bastion](/images/9_mail_bastion.png)
...
![Mail pentest on bastion](/images/10_rapport_pentest_mail.png)
...
![Pentest report pdf file](/images/11_pentest_report.png)
...
![Challenge infrastructure (simplified)](/images/12_simplified_challenge_infrastructure.png)
...
![Intranet login page](/images/13_login_page.png)
...
![Password reset](/images/14_reset_password.png)
...
![Password reset](/images/15_profile_url.png)
...
![SSTI first payload](/images/18_first_ssti_payload.png)
...
![SSTI successful RCE](/images/19_payload_worked.png)
...
And it works !
![Reverse Shell](/images/20_reverse_shell.png)
...
![Clients table](/images/21_camille_clients.png)
