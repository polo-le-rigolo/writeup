...
![Masa CMS API](/HTB-UNIV/2024/freedom/images/api_masa.png)
...
![Masa CMS Login](/HTB-UNIV/2024/freedom/images/login_masa_cms.png)
...
Playing around with several requests and looking at the answers on burp we managed to pinpoint the exact version of the CMS : Masa CMS 7.4.5
  ![Masa CMS version](/HTB-UNIV/2024/freedom/images/masa_cms_version.png)
## SQLi
...
![Masa CMS version](/HTB-UNIV/2024/freedom/images/masa_sql_error.png)
...
![Reset admin pwd](/HTB-UNIV/2024/freedom/images/rest_admin_pwd.png)
...
![Token db](/HTB-UNIV/2024/freedom/images/token_db.png)
...
Looking around the administration page, we found an interesting feature : 
 ![Upload plugin](/HTB-UNIV/2024/freedom/images/upload_plugin.png)
...
We zipped the whole plugin again with our malicious : `config.xml.cfm`
 ![Payload](/HTB-UNIV/2024/freedom/images/malicious_payload.png)
And uploaded it onto the CMS : 

![Zip exploit](/HTB-UNIV/2024/freedom/images/exploitzip.png)

Now to trigger our payload we just clicked on "Deploy" and we got our shell : 

![Reverse shell](/HTB-UNIV/2024/freedom/images/reverse_shell.png)
